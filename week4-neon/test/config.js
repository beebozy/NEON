...
module.exports = {
    ...
    svm_node: {
    curvestand: `https://devnet.helius-rpc.com/?api-key=${HELIUS_API_KEY}`,
    neondevnet: `https://devnet.helius-rpc.com/?api-key=${HELIUS_API_KEY}`,
    neonmainnet: `https://mainnet.helius-rpc.com/?api-key=${HELIUS_API_KEY}`,
},
    composability: {
        CallSystemProgram: {
            curvestand: "",
