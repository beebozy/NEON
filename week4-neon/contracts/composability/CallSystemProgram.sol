...
// A new custom instruction 
/// @notice Creates a new Solana account without using a seed
/// @param newAccount The public key of the account to be created
/// @param programId The program ID that will own the new account
/// @param accountSize The storage space to allocate for the new account
function createAccountWithoutSeed(
    ...
    // two new custom library though not safe 
