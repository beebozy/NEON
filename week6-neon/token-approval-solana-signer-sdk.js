...
async function init() {
    ...
    if (await connection.getBalance(solanaUser.publicKey)==0){
        ...
        console.error('\n pleaese Send some solana to this user', solanaUser.publicKey.tobase58());

        process.exit();
    }

    console.log('usdc approval of ',solanaUser.neonWallet, 'is', await USDC.allowance(solanaUser.neonWallet, solanaUser.neonWallet));
